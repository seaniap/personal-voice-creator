...
1. **選擇語言** — 從 English、繁體中文、日本語中選一個，整個流程都會以該語言進行
2. **訪談** — Claude 問你寫作習慣的問題，同時穿插情境提示（「在晚宴上遇到陌生人，你怎麼介紹自己在做的事？」），在對話中直接捕捉你的自然語感
3. **樣本** — 你提供至少 3 篇跨情境的寫作（貼文、商務信、長文各一），跨情境比對才能找出真正穩定的聲音特徵
4. **測試與校準** — Claude 寫測試稿，你修改到它聽起來像你為止
5. **打包** — 你得到一個可以永久安裝使用的 `personal-voice.skill`
...
- 至少 3 篇跨情境的真實寫作樣本（貼文、商務信、長文各一，越多樣越好）
- 15～20 分鐘進行訪談與校準
